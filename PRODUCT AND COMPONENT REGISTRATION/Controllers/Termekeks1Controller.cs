...
{
    public class Termekeks1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Termekeks1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: Termekeks1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Termekeks1/Create
